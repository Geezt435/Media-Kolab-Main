...
<body class="app">
	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
												...
												foreach ($result = mysqli_fetch_all($request) as $index) {
													...
													echo <<<TULIS
															<tr>
																...
																<td class="cell">
																	<a class="btn-sm app-btn-danger" data-toggle="modal" href="#delete-media" onclick="getMediaId('$mediaId')">Delete</a>
																</td>
															</tr>
														TULIS;
												}
				...
				<!-- Modal -->
				<div class="modal fade" id="delete-media" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<form action="managemedia.php" method="GET" id="conDeleteMedia">
	...
	<script>
		function getMediaId(mediaId) {
			console.log(mediaId);
			const formDelete = document.getElementById("conDeleteMedia");
			const createInput = document.createElement("input");

			createInput.setAttribute("type", "hidden");
			createInput.setAttribute("name", "mediaId");
			createInput.setAttribute("value", mediaId);
