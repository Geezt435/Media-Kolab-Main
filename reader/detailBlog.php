...
$query3 = "SELECT tb_blog.category_id, tb_category_blog.category_name, COUNT(tb_blog.category_id) AS jumlah_kategori FROM tb_category_blog INNER JOIN tb_blog ON tb_category_blog.category_id = tb_blog.category_id GROUP BY tb_blog.category_id";
$query4 = "SELECT COUNT(blog_id) AS jumlah_event FROM tb_blog";
