...
$query2 = "SELECT tb_blog.category_id, tb_category_blog.category_name, COUNT(tb_blog.category_id) AS jumlah_kategori FROM tb_category_blog INNER JOIN tb_blog ON tb_category_blog.category_id = tb_blog.category_id GROUP BY tb_blog.category_id";
$query3 = "SELECT COUNT(blog_id) AS jumlah_blog FROM tb_blog";
$data2 = mysqli_query($conn, $query2);
$result2 = mysqli_fetch_all($data2);
$data3 = mysqli_query($conn, $query3);
$result3 = mysqli_fetch_array($data3);

$query4 = "SELECT blog_id, blog_title, date_release, views, image_url FROM tb_blog ORDER BY views desc limit 3";
											...
											<div class="post post-grid rounded bordered">
												...
												<div class="details">
													<ul class="meta list-inline mb-0">
														<li class="list-inline-item"><a href="detailBlog.php?blogId=$blogId">$editorUsername</a></li>
														<li class="list-inline-item">$dateRelease</li>
													</ul>
													<h5 class="post-title mb-3 mt-3"><a href="detailBlog.php?blogId=$blogId">$blogTitle</a></h5>
												</div>
