...
$query3 = "SELECT tb_event.category_id, tb_category_event.category_name, COUNT(tb_event.category_id) AS jumlah_kategori FROM tb_category_event INNER JOIN tb_event ON tb_category_event.category_id = tb_event.category_id GROUP BY tb_event.category_id";
$query4 = "SELECT COUNT(event_id) AS jumlah_event FROM tb_event";
			...
			<div class="container-xl">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page"><?php echo $request["event_title"] ?></li>
					</ol>
				</nav>
					...
					<div class="col-lg-8">
						...
						<div class="post post-single">
							...
							<div class="post-header">
								<h1 class="title mt-0 mb-3"><?php echo $request["event_title"] ?></h1>
