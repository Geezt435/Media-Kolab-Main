	...
	if ($_SERVER['REQUEST_METHOD'] == "POST") {
		...
		if (isset($_POST['createJob'])) {
			...
			$sqlCreate = "INSERT INTO tb_job_vacancies (vacancy_id, vacancy_title, vacancy_content, vacancy_requirement, date_release, image_url, video_url, views, tag_id, category_id, editor_id, logo, company_name)
				VALUES (:vacancy_id, :createTitle, :content, :requirements, :currentDate, :image_url, :video_url, 0, :tagId, :categoryId, :editor_id_cur_session, :companyLogo, :company)";
			...
			$success = uploadImageJob($hashedLogo, $_FILES['companyLogo']);
			if ($success) {
...
<body class="app">
	...
	<script>
		function getDeleteJobId(blogId) {
			console.log(blogId)
